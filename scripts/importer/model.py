...
def import_model(directory: str, file_name: str, extension: Optional[str] = None) -> None:
    ...
    # Store the current state of the selected objects
    previous_selected_objects = bpy.context.selected_objects
    ...
    imported_objects = [obj for obj in bpy.context.selected_objects if obj not in previous_selected_objects]
